...
export default function ImportPage() {
  ...
  async function handleConfirm(txs: PreviewTx[]) {
    ...
    try {
      ...
      setResult({ inserted: data.inserted, skipped: data.skipped, months: data.months });
      setStage('done');
    } catch (err) {
      setError(err instanceof Error ? err.message : 'Unknown error');
    } finally {
    ...
    <div className="flex flex-col gap-8">
      <div>
        ...
        <p className="text-sm text-zinc-500 mt-0.5">
          Upload CSV exports from your bank accounts. Upload every Sunday to keep actuals up to date.
        </p>
      </div>
